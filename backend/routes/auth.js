...
//     body('password','password atlist must be 5 charaters').isLength({min:5})
//   ],
//   async (req, res) => {
...
//     try {
//       // 🔹 yahan sirf user variable banao, User nahi
...
//     } catch (error) {
//       console.error(error.message);   // 🔹 error spelling fix
